...
enum{EVALUACION_CURSO=C_1,GESTION_MATERIAS,CONTROL_TAREAS,AGENDA,NOTAS,SALIR};
...
int main()
{
    AdministradorNotas* administradorNota;
    administradorNota=new AdministradorNotas;
    ...
    do{
        ...
        case CONTROL_AGENDA:
            ...
            break;
        case NOTAS:
            administradorNota->menuAdministradorNotas();
        case SALIR:
